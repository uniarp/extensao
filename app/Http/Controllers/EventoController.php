...
class EventoController extends BaseController
{
    ...
    public function listarEvento($codEvento)
    {
        ...
        for ($e = 0; $e < count($evento); $e++) {
            ...
            $atividade = app('db')->select('SELECT atv.codatividade "codAtividade", atv.titulo, atv.codtipo, ta.nome "nomeTipo", atv.datainicio,
                atv.datafim, atv.localizacao, atv.descricao FROM atividade atv
