...
class PalestranteController extends BaseController
{
    ...
    public function listarPalestrante($codPalestrante)
    {
        ...
        for ($a = 0; $a < count($palestrantes); $a++) {
            $areasPalestrante = app('db')->select('SELECT a.codarea "codArea", a.nome FROM areapalestrante p
    ...
    public function excluirPalestrante($codPalestrante)
    {
        ...
        $erro = 'Não foi possível excluir: Motivo Palestrante já possui vinculo a uma atividade';
        return $erro;
    }
}
